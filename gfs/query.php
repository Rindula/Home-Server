...
if($t == "searchT") {
    ...
    if (trim($q) == "")
        die();
    $r = $conn->query("SELECT b.bez, b.author, bes.code FROM bestand as b inner join beschreibung as bes on bes.id = b.id inner join autoren as a on a.id = b.author WHERE a.autor LIKE '%$q%'");
