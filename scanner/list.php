...
<html lang="de">
    ...
    <body class="bg-dark">
        <input class="d-print-none form-control bg-dark text-light border border-warning rounded" id="datepick" value="<?= date("Y-m") ?>" type="month" onchange="update(this.value)">
        <br>
